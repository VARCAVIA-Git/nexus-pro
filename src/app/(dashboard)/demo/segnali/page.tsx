...
import { ArrowUpRight, ArrowDownRight, Minus, Zap, RefreshCw, Radio } from 'lucide-react';

const DEFAULT_SYMBOLS = ['BTC/USD', 'ETH/USD', 'SOL/USD', 'AAPL', 'NVDA', 'TSLA'];

export default function DemoSegnaliPage() {
  ...
  return (
    <div className="space-y-5 stagger">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-n-text">Segnali Demo</h1>
